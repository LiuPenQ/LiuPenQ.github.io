import{An as o,Ct as a,Dt as h,En as m,Jt as C,Lt as l,Pt as g,Qt as d,St as f,bt as n,ht as b,ut as P,vt as k,yt as w,zt as S}from"./index-B9j-PI2z.js";var x={class:"word-container"},E={class:"coding-section"},q={class:"coding-layout"},B={class:"problem-list"},$=["onClick"],j={key:0,class:"editor-section"},D={class:"problem-info"},N={class:"problem-description"},T={key:0,class:"problem-input"},A={key:1,class:"problem-output"},M={class:"editor-container"},V={key:0,class:"code-result"},W=h({__name:"WordCoding",setup(z){const u=d([]),p=d(null),s=d(""),r=d(null),t=w(()=>u.value.find(c=>c.id===p.value)||null),v=c=>{p.value=c;const i=u.value.find(e=>e.id===c);s.value=(i==null?void 0:i.initialCode)||"",r.value=null},y=()=>{t.value&&setTimeout(()=>{t.value&&(r.value=`代码运行成功！
输入：${t.value.input||"无"}
输出：${t.value.output||"无"}
