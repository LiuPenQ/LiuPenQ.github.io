import"./objectSpread2-C5mcNoIF.js";import{E as j,It as i,L as o,Mt as m,P as k,S as s,T as S,Y as x,g as f,h as _,i as P,rt as u,s as C,v as T,x as g,y as e,z as y}from"./index-BGrokQk7.js";import"./axios-4jfLCSor.js";import{t as M}from"./ai-B-eJI7cg.js";var O={class:"word-container"},E={class:"word-header"},V={class:"category-tabs"},D=["onClick"],N={class:"theory-section"},W={class:"theory-list"},R=["onClick"],A={class:"theory-header-left"},I={class:"theory-title"},U={key:0,class:"theory-stars"},B={class:"theory-header-right"},L=["onClick"],F={class:"theory-content"},H={key:0,class:"theory-answer"},$=j({__name:"WordTheory",setup(J){const c=M(),v=[{key:"vue",label:"Vue"},{key:"js",label:"JavaScript"},{key:"project",label:"项目"},{key:"code",label:"手写题"},{key:"engineering",label:"工程化"},{key:"browser",label:"浏览器"},{key:"ts",label:"TypeScript"},{key:"design",label:"设计模式"}],l=u("vue"),a=u(new Set),h=t=>{a.value.has(t)?a.value.delete(t):a.value.add(t)},b=t=>{const r=`当前正在复习八股文题目：${t.title}
题目内容：${t.content}`;c.setContext(r),c.openChat(),c.sendMessage(`请帮我详细解释一下这道题目：${t.title}

题目内容：${t.content}`)},p=u([]),w=T(()=>p.value.filter(t=>t.category===l.value));return k(()=>{p.value=[{id:101,title:"Vue2 响应式原理",content:"Object.defineProperty 怎么实现？数组怎么处理？缺点？",answer:`Vue2响应式原理（Object.defineProperty）：
...
\`\`\``,category:"design",stars:0}]}),(t,r)=>(o(),s("div",O,[e("div",E,[e("div",V,[(o(),s(f,null,y(v,n=>e("button",{key:n.key,class:m(["category-btn",{active:l.value===n.key}]),onClick:d=>l.value=n.key},i(n.label),11,D)),64))])]),e("div",N,[e("div",W,[(o(!0),s(f,null,y(w.value,n=>(o(),s("div",{key:n.id,class:"theory-item"},[e("div",{class:"theory-header group",onClick:d=>h(n.id)},[e("div",A,[e("h3",I,i(n.title),1),n.stars?(o(),s("span",U,i("⭐".repeat(n.stars)),1)):g("",!0)]),e("div",B,[e("button",{class:"btn-circle btn-circle-sm btn-circle-secondary group-hover:opacity-100",onClick:_(d=>b(n),["stop"]),title:"询问AI助手"},[...r[0]||(r[0]=[e("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor"},[e("path",{d:"M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"})],-1)])],8,L),(o(),s("svg",{class:m(["theory-arrow",{rotated:a.value.has(n.id)}]),xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[...r[1]||(r[1]=[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1)])],2))])],8,R),e("div",F,i(n.content),1),S(C,{name:"expand"},{default:x(()=>[n.answer&&a.value.has(n.id)?(o(),s("div",H,[r[2]||(r[2]=e("h4",null,"答案：",-1)),e("div",null,i(n.answer),1)])):g("",!0)]),_:2},1024)]))),128))])])]))}}),K=P($,[["__scopeId","data-v-f5f6d941"]]);export{K as default};
