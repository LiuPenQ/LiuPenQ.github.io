import{$t as l,Bt as p,Ct as d,Dn as m,Dt as b,Ft as w,Jt as j,Ot as k,Rt as t,bt as S,dt as x,jn as s,ut as _,vt as f,wt as r,xt as e}from"./index-DXNxgZka.js";var P={class:"word-container"},C={class:"word-header"},T={class:"category-tabs"},O=["onClick"],M={class:"theory-section"},D={class:"theory-list"},E=["onClick"],V={class:"theory-header-left"},N={class:"theory-title"},R={key:0,class:"theory-stars"},W={class:"theory-content"},A={key:0,class:"theory-answer"},U=k({__name:"WordTheory",setup(B){const g=[{key:"vue",label:"Vue"},{key:"js",label:"JavaScript"},{key:"project",label:"项目"},{key:"code",label:"手写题"},{key:"engineering",label:"工程化"},{key:"browser",label:"浏览器"},{key:"ts",label:"TypeScript"},{key:"design",label:"设计模式"}],c=l("vue"),a=l(new Set),y=o=>{a.value.has(o)?a.value.delete(o):a.value.add(o)},u=l([]),v=S(()=>u.value.filter(o=>o.category===c.value));return w(()=>{u.value=[{id:101,title:"Vue2 响应式原理",content:"Object.defineProperty 怎么实现？数组怎么处理？缺点？",answer:`Vue2响应式原理（Object.defineProperty）：
...
\`\`\``,category:"design",stars:0}]}),(o,i)=>(t(),r("div",P,[e("div",C,[e("div",T,[(t(),r(f,null,p(g,n=>e("button",{key:n.key,class:m(["category-btn",{active:c.value===n.key}]),onClick:h=>c.value=n.key},s(n.label),11,O)),64))])]),e("div",M,[e("div",D,[(t(!0),r(f,null,p(v.value,n=>(t(),r("div",{key:n.id,class:"theory-item"},[e("div",{class:"theory-header",onClick:h=>y(n.id)},[e("div",V,[e("h3",N,s(n.title),1),n.stars?(t(),r("span",R,s("⭐".repeat(n.stars)),1)):d("",!0)]),(t(),r("svg",{class:m(["theory-arrow",{rotated:a.value.has(n.id)}]),xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[...i[0]||(i[0]=[e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1)])],2))],8,E),e("div",W,s(n.content),1),b(x,{name:"expand"},{default:j(()=>[n.answer&&a.value.has(n.id)?(t(),r("div",A,[i[1]||(i[1]=e("h4",null,"答案：",-1)),e("div",null,s(n.answer),1)])):d("",!0)]),_:2},1024)]))),128))])])]))}}),L=_(U,[["__scopeId","data-v-03c04f77"]]);export{L as default};
